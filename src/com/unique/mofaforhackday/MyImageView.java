...
public class MyImageView extends ImageView {
	...
	private void arithScaleRate() {
		float scaleWidth = CutPictureActivity.width0 / (float) imageWidth;
		float scaleHeight = CutPictureActivity.height0 / (float) imageHeight;
	...
	public void setImageBitmap(Bitmap bitmap) {
		...
		arithScaleRate();
		//缩放到屏幕大小
		zoomTo(scaleRate,CutPictureActivity.width0 / 2f, CutPictureActivity.height0 / 2f);
...
//		RectF rect = new RectF(0, 0, imageWidth*getScale(), imageHeight*getScale());
	...
	public void layoutToCenter()
	{
		...
		//空白区域宽高
		float fill_width = CutPictureActivity.width0 - width;
		float fill_height = CutPictureActivity.height0 - height;
	...
	protected float getValue(Matrix matrix, int whichValue) {
		...
		mMinZoom =( CutPictureActivity.width0/2f)/imageWidth;
	...
	// Combine the base matrix and the supp matrix to make the final matrix.    xmlns:app="http://schemas.android.com/apk/res/com.unique.mofaforhackday"
